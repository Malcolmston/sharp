...
export function App() {
  ...
  const brand = { title: 'malcolmston', sub: '/sharp', initials: 'sh', href: '#overview' };
  const footer: ReactNode = (
    <div>
      <span className="grad-text" style={{ fontWeight: 700 }}>malcolmston/sharp</span> — fluent, chainable image processing, reimagined in Go.
      <div className="small dim" style={{ marginTop: '.4rem' }}>MIT licensed · standard-library-only re-imagining of Node's sharp</div>
    </div>
  );

  return (
    <Layout brand={brand} tabs={TABS} active={active} onNav={go} github="https://github.com/malcolmston/sharp" footer={footer}>
