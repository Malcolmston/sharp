...
import { SHARP } from '../data';

// Scoped to this repository only: the live release history is read straight from
// the GitHub Releases API for malcolmston/sharp.
const RELEASE_LIBS: RelLib[] = [
  { name: SHARP.name, icon: SHARP.icon, accent: SHARP.accent, repo: ghrepo(SHARP), url: SHARP.repo },
];
